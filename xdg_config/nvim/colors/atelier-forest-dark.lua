...
vim.api.nvim_set_hl(0, 'Delimiter', { fg = '#a8a19f' }) -- base05
vim.api.nvim_set_hl(0, '@punctuation.delimiter', { fg = '#a8a19f' })
vim.api.nvim_set_hl(0, '@punctuation.bracket', { fg = '#a8a19f' })
